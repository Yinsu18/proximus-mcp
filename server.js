...
// ============================ package.json ============================
// Place this in package.json at the repo root
/*
{
  "name": "proximus-mcp",
  "version": "1.0.0",
...
// ============================ render.yaml =============================
// Optional Render Blueprint so you can one-click deploy this service.
/*
services:
  - type: web
    name: proximus-mcp
...
// =============================== README ===============================
// 1) Create repo with server.js, package.json, render.yaml
// 2) Push to GitHub
// 3) In Render: New → Web Service → Connect this repo
//    - Build: npm install
//    - Start: node server.js
//    - Health Check Path: /healthz
//    - Env Vars: MCP_REQUIRE_KEY=true (optional), MCP_API_KEY=<secret>
// 4) After deploy, you should see /healthz → ok
// 5) Test locally or via curl:
//    curl -X POST https://<your-mcp>.onrender.com/query \
//      -H 'Content-Type: application/json' \
//      -H 'Authorization: Bearer <MCP_API_KEY>' \
//      -d '{"prompt":"Compute KPIs","resource":"kpis","filters":{"country":"CO"}}'
// 6) In your DEMO app, set: MCP_URL=https://<your-mcp>.onrender.com/query
//    and (if you enabled key) MCP_API_KEY=<same secret>
